...
void print_line(gpointer data, gpointer user_data) {
...
void render_screen_debug(Screen s) {
    g_list_foreach(s->lines, print_line, NULL);
    ...
    mvprintw(3, getmaxx(stdscr)-13, "LG: %d - %d", cur_buf->gap_start, cur_buf->gap_end);
    ...
    if (cur_buf->buffer[cur_buf->cursor] == '\n')
        ...
        mvprintw(5, getmaxx(stdscr)-13, "C on: (%c)", cur_buf->buffer[cur_buf->cursor]);
...
/* void render_screen_debug(Screen s) { */
    ...
    /* mvprintw(4, getmaxx(stdscr)-13, "L_len: %d", s->cur_line_length); */
    ...
    /* mvprintw(6, getmaxx(stdscr)-13, "CurRow: %d", s->row); */
    /* mvprintw(7, getmaxx(stdscr)-13, "CurCol: %d", s->col); */
